    ...
    <div class="card-body">
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 text-primary"><span class="font-weight-bold">Cập nhật </span> chi tiết sản phẩm</h6>
            </div>
            <div class="row">
                <div class="col-md-6 ">
                    <form class="m-4" method="POST" action="{{ route('product_detail.update',$pro_detail->id) }}">
                        @csrf @method('PUT')
                        <input type="text" name="product_id" value="{{$pro_detail->product->id}}" hidden>
                        <div class=" form-group">
                            <label class="font-weight-bold text-success">Sản phẩm </label>
                            <input type="text" class=" form-control border border-success" value="{{$pro_detail->product->name}}" disabled>
                        </div>
                        <div class=" form-group">
                            ...
                            <div class="form-check">
                                ...
                                @if(($pro_detail->status==1&&old('status')=='')||old('status')==1)
                                  {{'checked'}}
                                @endif
                                >
                            ...
                            <div class="form-check">
                                ...
                                @if(($pro_detail->status==0&&old('status')=='')||(old('status')==0&&old('status')!=''))
                                  {{'checked'}}
                                @endif
                                >
                        ...
                        <div class=" form-group col-md-6">
                            ...
                            <input type="text" class=" form-control border border-success" id="price" name="price" value="{{(old('price'))?old('price'):$pro_detail->price}}">
                        ...
                        <div class=" form-group col-md-6">
                            ...
                            <input type="text" class=" form-control border border-success" id="sale_price" name="sale_price" value="{{(old('sale_price'))?old('sale_price'):$pro_detail->sale_price}}">
                        ...
                        <div class=" form-group col-md-6">
                            ...
                            <input type="text" class=" form-control border border-success" id="ram" name="ram" value="{{(old('ram'))?old('ram'):$pro_detail->ram}}">
                        ...
                        <div class=" form-group col-md-6">
                            ...
                            <input type="text" class=" form-control border border-success" id="cpu" name="cpu" value="{{(old('cpu'))?old('cpu'):$pro_detail->cpu}}">
                        ...
                        <div class=" form-group col-md-6">
                            ...
                            <input type="text" class=" form-control border border-success" id="memory" name="memory" value="{{(old('memory'))?old('memory'):$pro_detail->memory}}">
