...
@section('title','Cập nhật chương trình khuyến mại')
                ...
                <div class="container-fluid">
                    ...
                    <!-- <div class="collapse" id="collapseExample"> -->
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    <form class="m-4" method="POST" action="{{route('promotion.update',$promo->id) }}">
                                        @csrf @method("PUT")
                                        ...
                                        <div class=" form-group">
                                            ...
                                            <input type="text" class=" form-control border border-success" id="name" name="name" value="{{$promo->name}}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="detail1" id="input" class="form-control" rows="3" >{{$promo->detail1}}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="font-weight-bold text-success" for="name">Nội dung </label>
                                            <textarea name="detail2" id="input" class="form-control" rows="3" >{{$promo->detail2}}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="font-weight-bold text-success" for="name">Nội dung </label>
                                            <textarea name="detail3" id="input" class="form-control" rows="3" >{{$promo->detail3}}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="font-weight-bold text-success" for="name">Nội dung </label>
                                            <textarea name="detail4" id="input" class="form-control" rows="3" >{{$promo->detail4}}</textarea>
                                        </div>
                                        <div class="form-group">
                                            <label class="font-weight-bold text-success" for="name">Nội dung </label>
                                            <textarea name="detail5" id="input" class="form-control" rows="3" >{{$promo->detail5}}</textarea>
                                        </div>
